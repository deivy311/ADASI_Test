...
int main(int argc, char *argv[])
{
  ...
  pipeline = local_pipeline_manager->setup_gst_pipeline(overlay_state,local_pipeline_manager->source_type, local_pipeline_manager->host, local_pipeline_manager->port,local_pipeline_manager->RTSP_port,local_pipeline_manager->RTSP_file_path);
